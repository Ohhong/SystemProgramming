...
int progaddr, execaddr;		//Program address //Excution address
ESTAB estab[3];		//ESTABLE
int reg[10], bp[20], total_len, bpi, flag;	//register A, X, L, B, S, T, F, PC, SW //Break points //Program's total length //Break point index // Flag for starting point
